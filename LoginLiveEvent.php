...
<head>
    ...
    <meta property="og:title" content="LoginLiveEvent">
...
<body class="u-body u-xl-mode" data-lang="en">
                    ...
                    <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                        <div class="u-inner-container-layout u-sidenav-overflow">
                            ...
                            <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-5">
                                ...
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="donate.php" style="cursor:pointer ;">Donate us</a>
                                </li>
    ...
    <section class="u-clearfix u-section-2" id="sec-f1d6">
        <div class="u-clearfix u-sheet u-sheet-1">
            ...
            <div class="u-blog u-expanded-width u-blog-1">
                <div class="u-repeater u-repeater-1">
                    ...
                    <?php
                        ...
                        $conn->close();
                    ?>
                        <div class="u-container-layout u-similar-container u-container-layout-1" action="" method="post">
                            ...
                            <p class="u-align-left u-text u-text-2">We are collecting fund for feeding the street people.<br>Location: Chennai,Kellambakkam railway station, Tamil Nadu.
                            </p>
                            <p class="u-align-left u-text u-text-3">Fri. 23 May 2023</p>
                    ...
                    <div class="u-blog-post u-container-style u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-2">
                            ...
                            <p class="u-align-left u-text u-text-6">Sat, 1 april 2023</p>
                            <?php  while($row = mysqli_fetch_array($result)){
                            echo "Total Donation :". $row['SUM(l_amount)'];
                              echo "<br />";
                        }?>
            ...
            <!--/blog-->
            <a class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-6 u-btn-1" href="donate.php">Donate<span style="font-size: 1rem;">
            <span style="font-size: 1.125rem;"></span>
          </span>
        </a>
            <a href="LoginHome.php#contact" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-2-light-1 u-palette-2-light-1 u-radius-6 u-btn-2">Cick to add event</a>
        </div>
    </section>
    <style>
        body {
